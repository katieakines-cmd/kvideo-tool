// pages/Studio.jsx — moved from App.jsx
// This is the main recording studio experience, now living at route "/".
// Added: link to the Brandbook page in the header.
...
function Studio() {
  // Pull the live brand theme so every style in this page
  // repaints instantly when the user changes it in the Brandbook.
  ...
  return (
    <div style={styles.app}>
      ...
      <header style={styles.header}>
        <div style={headerRow}>
          ...
          <div style={headerActions}>
            <Link to="/brandbook" style={brandbookLink}>
              🎨 Brandbook
            </Link>
          </div>
        </div>
      ...
      <div style={styles.content}>
        <MicVisualizer micLevel={micLevel} styles={styles} />
      ...
      <TakesLibrary recordings={recordings} styles={styles} />
...
const headerSpacer = {
  width: "110px", // balances the Brandbook link width so title stays centered
}
const headerActions = {
  width: "110px",
  display: "flex",
